...
WEBAPP_BUCKET=$(aws cloudformation describe-stack-resources --stakc-name ${STACK_NAME} --logical-resource-id WebAppBucket --output text --query 'StackResources[0].PhysicalResourceId') 
